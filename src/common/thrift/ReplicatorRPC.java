              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.batch = new ArrayList<CRDTPreCompiledTransaction>(_list134.size);
                  CRDTPreCompiledTransaction _elem135;
                  for (int _i136 = 0; _i136 < _list134.size; ++_i136)
                  {
                    _elem135 = new CRDTPreCompiledTransaction();
                    _elem135.read(iprot);
                    struct.batch.add(_elem135);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendBatchToRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.batch != null) {
          oprot.writeFieldBegin(BATCH_FIELD_DESC);
          {
            ...
            for (CRDTPreCompiledTransaction _iter137 : struct.batch)
            {
        ...
        if (struct.isSetBatch()) {
          {
            ...
            for (CRDTPreCompiledTransaction _iter138 : struct.batch)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.batch = new ArrayList<CRDTPreCompiledTransaction>(_list139.size);
            CRDTPreCompiledTransaction _elem140;
            for (int _i141 = 0; _i141 < _list139.size; ++_i141)
            {
              _elem140 = new CRDTPreCompiledTransaction();
              _elem140.read(iprot);
              struct.batch.add(_elem140);
            }
          }
          struct.setBatchIsSet(true);
        }
