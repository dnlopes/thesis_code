              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.batch = new ArrayList<CRDTCompiledTransaction>(_list98.size);
                  CRDTCompiledTransaction _elem99;
                  for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                  {
                    _elem99 = new CRDTCompiledTransaction();
                    _elem99.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendBatchToRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.batch != null) {
          oprot.writeFieldBegin(BATCH_FIELD_DESC);
          {
            ...
            for (CRDTCompiledTransaction _iter101 : struct.batch)
            {
        ...
        if (struct.isSetBatch()) {
          {
            ...
            for (CRDTCompiledTransaction _iter102 : struct.batch)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.batch = new ArrayList<CRDTCompiledTransaction>(_list103.size);
            CRDTCompiledTransaction _elem104;
            for (int _i105 = 0; _i105 < _list103.size; ++_i105)
            {
              _elem104 = new CRDTCompiledTransaction();
              _elem104.read(iprot);
              struct.batch.add(_elem104);
            }
          }
          struct.setBatchIsSet(true);
        }
