            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.opsList = new ArrayList<CRDTPreCompiledOperation>(_list116.size);
                CRDTPreCompiledOperation _elem117;
                for (int _i118 = 0; _i118 < _list116.size; ++_i118)
                {
                  _elem117 = new CRDTPreCompiledOperation();
                  _elem117.read(iprot);
                  struct.opsList.add(_elem117);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.symbolsMap = new HashMap<String,SymbolEntry>(2*_map119.size);
                String _key120;
                SymbolEntry _val121;
                for (int _i122 = 0; _i122 < _map119.size; ++_i122)
                {
                  _key120 = iprot.readString();
                  _val121 = new SymbolEntry();
                  _val121.read(iprot);
                  struct.symbolsMap.put(_key120, _val121);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CRDTPreCompiledTransaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.opsList != null) {
        oprot.writeFieldBegin(OPS_LIST_FIELD_DESC);
        {
          ...
          for (CRDTPreCompiledOperation _iter123 : struct.opsList)
          {
      ...
      if (struct.symbolsMap != null) {
        oprot.writeFieldBegin(SYMBOLS_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, SymbolEntry> _iter124 : struct.symbolsMap.entrySet())
          {
      ...
      if (struct.isSetOpsList()) {
        {
          ...
          for (CRDTPreCompiledOperation _iter125 : struct.opsList)
          {
      ...
      if (struct.isSetSymbolsMap()) {
        {
          ...
          for (Map.Entry<String, SymbolEntry> _iter126 : struct.symbolsMap.entrySet())
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.opsList = new ArrayList<CRDTPreCompiledOperation>(_list127.size);
          CRDTPreCompiledOperation _elem128;
          for (int _i129 = 0; _i129 < _list127.size; ++_i129)
          {
            _elem128 = new CRDTPreCompiledOperation();
            _elem128.read(iprot);
            struct.opsList.add(_elem128);
          }
        }
        struct.setOpsListIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.symbolsMap = new HashMap<String,SymbolEntry>(2*_map130.size);
          String _key131;
          SymbolEntry _val132;
          for (int _i133 = 0; _i133 < _map130.size; ++_i133)
          {
            _key131 = iprot.readString();
            _val132 = new SymbolEntry();
            _val132.read(iprot);
            struct.symbolsMap.put(_key131, _val132);
          }
        }
        struct.setSymbolsMapIsSet(true);
      }
