...
public class DeletedField extends DataField
{
	 ...
	 * @return
	 *
	 * @see common.database.field.DataField#get_Crdt_Form(java.sql.ResultSet, String)
	 */
	@Override
	 ...
	 * @return
	 *
	 * @see common.database.field.DataField#get_Crdt_Form(String)
	 */
	@Override
	 ...
	 * @return
	 *
	 * @see common.database.field.DataField#get_Value_In_Correct_Format(String)
	 */
	@Override
	 ...
	 * @return
	 *
	 * @see common.database.field.DataField#getDefaultValue()
	 */
