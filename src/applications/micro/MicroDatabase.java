...
public class MicroDatabase implements MicroConstants
{
	...
	{
		String proc = "CREATE FUNCTION testClock(currentClock CHAR(100), newClock CHAR(100)) RETURNS int BEGIN " +
				"DECLARE" +
				" " +
				"isConcurrent BOOL; DECLARE isLesser BOOL; DECLARE isGreater BOOL; DECLARE returnValue INT; SET " +
				"@returnValue = 0; SET @isConcurrent = FALSE; SET @isLesser = FALSE; SET @isGreater = FALSE; " +
				"loopTag:" +
				" " +
				...
				"then second' as 'Message';*/ ELSEIF(@isConcurrent) then SELECT 3 INTO @returnValue; /* SELECT " +
				"'Clocks" +
