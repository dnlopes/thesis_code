 ...
 *
 * @author <a href="mailto:Emmanuel.Cecchet@inrialpes.fr">Emmanuel Cecchet</a> and <a href="mailto:julie.marguerite@inrialpes.fr">Julie Marguerite</a>
 * @version 1.0
 */
...
public class DatabaseProperties
{
  ...
  /**
   * Creates a new <code>DatabaseProperties</code> instance.
   * If the cjdbc.properties file is not found in the classpath,
  ...
  public DatabaseProperties()
  {
    ...
    System.out.println(
      "Looking for database.properties in classpath ("
    ...
    {
      System.err.println(
        "No database.properties file has been found in your classpath.");
      Runtime.getRuntime().exit(1);
    }
  }

  /**
   * Returns the value corresponding to a property in the database.properties file.
   *
  ...
  /**
   * Check for all needed fields in database.properties and 
   * inialize corresponding values.
   */
  public boolean checkPropertiesFile()
  {
    ...
    {
      System.err.println(
        "Error while checking database.properties: " + e.getMessage());
      return false;
    }
  }
