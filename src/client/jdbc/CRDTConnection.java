...
import common.util.exception.MissingImplementationException;
...
public class CRDTConnection implements Connection
{
	...
	public CRDTConnection() throws SQLException
	{
		...
		this.connectionId = this.proxy.assignConnectionId();
	}

	@Override
	public Statement createStatement() throws SQLException
	{
		return new CRDTStatement(this.connectionId, proxy);
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException
	{
		return new CRDTPreparedStatement(sql, this.connectionId, proxy);
	}

	@Override
	public void commit() throws SQLException
	{
		this.proxy.commit(this.connectionId);
	}
	...
	public void rollback() throws SQLException
	{
		...
		this.proxy.abort(this.connectionId);
	}
