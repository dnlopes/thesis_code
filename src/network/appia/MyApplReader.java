...
import net.sf.appia.test.appl.ApplAsyncEvent;
...
class MyApplReader implements Runnable {

  private MyApplSession parentSession;
  private java.io.BufferedReader keyb;
  private String                 local=null;

  public MyApplReader(MyApplSession parentSession) {
    super();
