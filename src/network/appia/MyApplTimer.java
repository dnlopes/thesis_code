...
public class MyApplTimer extends Timer {

  public  String msg;
  public  int totalResend, thisResend, period;
  public  int[] dest;

  private MyApplSession parent;

  public MyApplTimer(Channel c, MyApplSession  gen, String msg, int totalResend, int period, int[] dest) throws AppiaEventException, AppiaException {
