 ...
 */
public class SharedProxy extends AbstractNode implements Proxy
{
	...
	public SharedProxy(NodeConfig config)
	{
		...
		this.networkInterface = new PoolProxyNetwork(this.privateConfig);
		this.transactionsCounter = new AtomicInteger();
		this.scratchpadsCount = new AtomicInteger();
		this.connectionsCounter = 0;

		this.setup();
		System.out.println("SharedProxy " + this.config.getId() + " online");
	}

	public synchronized int assignConnectionId()
	{
