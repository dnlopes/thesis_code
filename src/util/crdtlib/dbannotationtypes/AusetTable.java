...
public class AusetTable extends DatabaseTable {
	 ...
	 */
	public AusetTable(String declaration, String tableName, LinkedHashMap<String, DataField> dataFields) {
		super(declaration, tableName, CrdtTableType.AUSETTABLE, dataFields);
