            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.operations = new HashMap<Integer,String>(2*_map80.size);
                int _key81;
                String _val82;
                for (int _i83 = 0; _i83 < _map80.size; ++_i83)
                {
                  ...
                  struct.operations.put(_key81, _val82);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tempOperations = new HashMap<Integer,String>(2*_map84.size);
                int _key85;
                String _val86;
                for (int _i87 = 0; _i87 < _map84.size; ++_i87)
                {
                  ...
                  struct.tempOperations.put(_key85, _val86);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftShadowTransaction struct) throws org.apache.thrift.TException {
      ...
      if (struct.operations != null) {
        oprot.writeFieldBegin(OPERATIONS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, String> _iter88 : struct.operations.entrySet())
          {
      ...
      if (struct.tempOperations != null) {
        oprot.writeFieldBegin(TEMP_OPERATIONS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, String> _iter89 : struct.tempOperations.entrySet())
          {
  ...
  private static class ThriftShadowTransactionTupleScheme extends TupleScheme<ThriftShadowTransaction> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ThriftShadowTransaction struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.txnId);
      {
        ...
        for (Map.Entry<Integer, String> _iter90 : struct.operations.entrySet())
        {
      ...
      if (struct.isSetTempOperations()) {
        {
          ...
          for (Map.Entry<Integer, String> _iter91 : struct.tempOperations.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ThriftShadowTransaction struct) throws org.apache.thrift.TException {
      ...
      struct.setTxnIdIsSet(true);
      {
        ...
        struct.operations = new HashMap<Integer,String>(2*_map92.size);
        int _key93;
        String _val94;
        for (int _i95 = 0; _i95 < _map92.size; ++_i95)
        {
          ...
          struct.operations.put(_key93, _val94);
        }
      }
      struct.setOperationsIsSet(true);
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map96 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.tempOperations = new HashMap<Integer,String>(2*_map96.size);
          int _key97;
          String _val98;
          for (int _i99 = 0; _i99 < _map96.size; ++_i99)
          {
            ...
            struct.tempOperations.put(_key97, _val98);
          }
        }
        struct.setTempOperationsIsSet(true);
      }
