              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.batch = new ArrayList<CRDTCompiledTransaction>(_list128.size);
                  CRDTCompiledTransaction _elem129;
                  for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                  {
                    _elem129 = new CRDTCompiledTransaction();
                    _elem129.read(iprot);
                    struct.batch.add(_elem129);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendBatchToRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.batch != null) {
          oprot.writeFieldBegin(BATCH_FIELD_DESC);
          {
            ...
            for (CRDTCompiledTransaction _iter131 : struct.batch)
            {
        ...
        if (struct.isSetBatch()) {
          {
            ...
            for (CRDTCompiledTransaction _iter132 : struct.batch)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.batch = new ArrayList<CRDTCompiledTransaction>(_list133.size);
            CRDTCompiledTransaction _elem134;
            for (int _i135 = 0; _i135 < _list133.size; ++_i135)
            {
              _elem134 = new CRDTCompiledTransaction();
              _elem134.read(iprot);
