              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.batch = new ArrayList<CRDTCompiledTransaction>(_list108.size);
                  CRDTCompiledTransaction _elem109;
                  for (int _i110 = 0; _i110 < _list108.size; ++_i110)
                  {
                    _elem109 = new CRDTCompiledTransaction();
                    _elem109.read(iprot);
                    struct.batch.add(_elem109);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, sendBatchToRemote_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.batch != null) {
          oprot.writeFieldBegin(BATCH_FIELD_DESC);
          {
            ...
            for (CRDTCompiledTransaction _iter111 : struct.batch)
            {
        ...
        if (struct.isSetBatch()) {
          {
            ...
            for (CRDTCompiledTransaction _iter112 : struct.batch)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.batch = new ArrayList<CRDTCompiledTransaction>(_list113.size);
            CRDTCompiledTransaction _elem114;
            for (int _i115 = 0; _i115 < _list113.size; ++_i115)
            {
              _elem114 = new CRDTCompiledTransaction();
              _elem114.read(iprot);
              struct.batch.add(_elem114);
            }
          }
          struct.setBatchIsSet(true);
        }
