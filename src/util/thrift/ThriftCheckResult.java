...
public class ThriftCheckResult implements org.apache.thrift.TBase<ThriftCheckResult, ThriftCheckResult._Fields>, java.io.Serializable, Cloneable, Comparable<ThriftCheckResult> {
  ...
  private static final org.apache.thrift.protocol.TField FIELD_NAME_FIELD_DESC = new org.apache.thrift.protocol.TField("fieldName", org.apache.thrift.protocol.TType.STRING, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ThriftCheckResultStandardSchemeFactory());
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ThriftCheckResult.class, metaDataMap);
  }
  ...
  public ThriftCheckResult deepCopy() {
    return new ThriftCheckResult(this);
  }
  ...
  public ThriftCheckResult setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public ThriftCheckResult setSuccess(boolean success) {
    this.success = success;
    setSuccessIsSet(true);
    return this;
  }
  ...
  public ThriftCheckResult setResquestedValue(String resquestedValue) {
    this.resquestedValue = resquestedValue;
    return this;
  }
  ...
  public ThriftCheckResult setFieldName(String fieldName) {
    this.fieldName = fieldName;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ThriftCheckResult)
      return this.equals((ThriftCheckResult)that);
    return false;
  }
  ...
  @Override
  public int compareTo(ThriftCheckResult other) {
  ...
  private static class ThriftCheckResultStandardSchemeFactory implements SchemeFactory {
    public ThriftCheckResultStandardScheme getScheme() {
      return new ThriftCheckResultStandardScheme();
    }
  }

  private static class ThriftCheckResultStandardScheme extends StandardScheme<ThriftCheckResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ThriftCheckResult struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ThriftCheckResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ThriftCheckResultTupleSchemeFactory implements SchemeFactory {
    public ThriftCheckResultTupleScheme getScheme() {
      return new ThriftCheckResultTupleScheme();
    }
  }

  private static class ThriftCheckResultTupleScheme extends TupleScheme<ThriftCheckResult> {
