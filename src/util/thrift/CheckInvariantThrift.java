...
public class CheckInvariantThrift implements org.apache.thrift.TBase<CheckInvariantThrift, CheckInvariantThrift._Fields>, java.io.Serializable, Cloneable, Comparable<CheckInvariantThrift> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("CheckInvariantThrift");
  ...
  static {
    schemes.put(StandardScheme.class, new CheckInvariantThriftStandardSchemeFactory());
    schemes.put(TupleScheme.class, new CheckInvariantThriftTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(CheckInvariantThrift.class, metaDataMap);
  }

  public CheckInvariantThrift() {
  }
   ...
   */
  public CheckInvariantThrift(CheckInvariantThrift other) {
  ...
  public CheckInvariantThrift deepCopy() {
    return new CheckInvariantThrift(this);
  }
   ...
   * @see CheckInvariantType
   */
  public CheckInvariantThrift setType(CheckInvariantType type) {
    this.type = type;
    return this;
  }
  ...
  public CheckInvariantThrift setId(int id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public CheckInvariantThrift setFieldName(String fieldName) {
    this.fieldName = fieldName;
    return this;
  }
  ...
  public CheckInvariantThrift setTableName(String tableName) {
    this.tableName = tableName;
    return this;
  }
  ...
  public CheckInvariantThrift setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public CheckInvariantThrift setResquestedValue(String resquestedValue) {
    this.resquestedValue = resquestedValue;
    return this;
  }
  ...
  public CheckInvariantThrift setSuccess(boolean success) {
    this.success = success;
    setSuccessIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof CheckInvariantThrift)
      return this.equals((CheckInvariantThrift)that);
    return false;
  }

  public boolean equals(CheckInvariantThrift that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(CheckInvariantThrift other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("CheckInvariantThrift(");
    boolean first = true;
  ...
  private static class CheckInvariantThriftStandardSchemeFactory implements SchemeFactory {
    public CheckInvariantThriftStandardScheme getScheme() {
      return new CheckInvariantThriftStandardScheme();
    }
  }

  private static class CheckInvariantThriftStandardScheme extends StandardScheme<CheckInvariantThrift> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, CheckInvariantThrift struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, CheckInvariantThrift struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class CheckInvariantThriftTupleSchemeFactory implements SchemeFactory {
    public CheckInvariantThriftTupleScheme getScheme() {
      return new CheckInvariantThriftTupleScheme();
    }
  }

  private static class CheckInvariantThriftTupleScheme extends TupleScheme<CheckInvariantThrift> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, CheckInvariantThrift struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, CheckInvariantThrift struct) throws org.apache.thrift.TException {
