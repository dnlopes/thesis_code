...
public class LWW_STRING extends DataField
{
	 ...
	 * 		the position
	 */
	public LWW_STRING(String dFN, String tN, String dT, boolean iPK, boolean iAIC, int position, SemanticPolicy policy)
	{
		super(CrdtDataFieldType.LWWSTRING, dFN, tN, dT, iPK, iAIC, position, policy);
	}
