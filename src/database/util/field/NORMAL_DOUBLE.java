...
public class NORMAL_DOUBLE extends DataField
{
	 ...
	 * 		the position
	 */
	public NORMAL_DOUBLE(String dFN, String tN, String dT, boolean iPK, boolean iAIC, int position,
						 SemanticPolicy policy)
	{
		super(CrdtDataFieldType.NORMALDOUBLE, dFN, tN, dT, iPK, iAIC, position, policy);
	}
