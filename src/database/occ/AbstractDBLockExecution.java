...
public abstract class AbstractDBLockExecution implements ExecutionPolicy
{
	...
	static final Logger LOG = LoggerFactory.getLogger(AbstractDBLockExecution.class);
...
*/
	 ...
	 * @throws SQLException
	 */
	protected void addToResultList(ResultSet rs, List<String[]> result, IDBScratchpad db, ExecutionPolicy[] policies,
...
*/
			...
			throws ScratchpadException
	{
		try
		{
			...
			while(colSet.next())
			{
				...
				buffer.append(" ");
				String[] tmpStr = {""};
				if(colSet.getString(6).contains(" ") == true)
				{        // column type
			...
			LOG.debug("Unique indices: " + uqIndicesPlain);
	 ...
	 * @throws ScratchpadException
	 */
	public Result executeTempOpSelect(Operation op, Select dbOp, IDBScratchpad db, ExecutionPolicy[] policies,
	 ...
	 * @throws ScratchpadException
	 */
	public ResultSet executeTempOpSelectOrig(Operation op, Select dbOp, IDBScratchpad db, ExecutionPolicy[] policies,
	...
	@Override
	public Result executeTemporaryQuery(Operation dbOp, IDBScratchpad db, ExecutionPolicy[] policies, String[][] tables)
			throws SQLException, ScratchpadException
	{
		if(dbOp.getStatementObj() instanceof Select)
	 ...
	 */
	@Override
	public ResultSet executeTemporaryQueryOrig(Operation dbOp, IDBScratchpad db, ExecutionPolicy[] policies,
											   String[][] tables) throws SQLException
	{
		if(dbOp.getStatementObj() instanceof Select)
