...
public interface ExecutionPolicy
{
	 ...
	 */
	Result executeTemporaryQuery( Operation dbOp, IDBScratchpad db, String[] table) throws SQLException, ScratchpadException;

	/**
	 * Executes a query in the scratchpad temporary state for a query that combines multiple ExecutionPolicies.
	 * @throws ScratchpadException
	 */
	Result executeTemporaryQuery( Operation dbOp, IDBScratchpad db, ExecutionPolicy[] policies, String[][] table) throws SQLException, ScratchpadException;
	...
	ResultSet executeTemporaryQueryOrig( Operation dbOp, IDBScratchpad db, ExecutionPolicy[] policies, String[][] table) throws SQLException;
	 ...
	 * @param b
	 */
	void executeDefiniteUpdate(Operation dbOp, IDBScratchpad db, LogicalClock lc, TimeStamp ts, boolean b) throws SQLException;
	/**
	 * Executes an update in the scratchpad final state for generic operation.
	 * @param b
	 */
	Result executeDefiniteUpdate1(Operation dbOp, IDBScratchpad db, LogicalClock lc, TimeStamp ts,
