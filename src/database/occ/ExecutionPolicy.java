...
public interface ExecutionPolicy
{
	 ...
	 * @throws ScratchpadException
	 */
	Result executeTemporaryQuery(DBSingleOperation dbOp, IDBScratchpad db, ExecutionPolicy[] policies, String[][] table)
			throws SQLException, ScratchpadException;
	...
	ResultSet executeTemporaryQueryOrig(DBSingleOperation dbOp, IDBScratchpad db, ExecutionPolicy[] policies,
