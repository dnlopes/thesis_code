...
public class CRDTConnection implements Connection
{
	...
	static
	{
		...
		AbstractNodeConfig config = Configuration.getInstance().getProxyConfigWithIndex(PROXY_ID);
	...
	{
		this.shdOpCreator = new MyShadowOpCreator(Configuration.getInstance().getSchemaFile(), proxy);
	...
	public Statement createStatement() throws SQLException
	{
		if(this.txnId.getValue() == TransactionIdentifier.DEFAULT_VALUE)
			proxy.beginTransaction(txnId);

		return new CRDTStatement(proxy, this.shdOpCreator, this.txnId);
	}
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException
	{
		...
		return new CRDTPreparedStatement(sql, proxy, this.shdOpCreator, this.txnId);
	}

	@Override
	public void commit() throws SQLException
	{
		if(!proxy.commit(this.txnId))
