...
public abstract class DBGenericOperation extends DBOperation
{
	...
	/**
	 * Should return true if individual sql operations must be registered for reexecution. Otherwise, big operation is
	 * registered.
	 *
	 * @return
	 */
	 ...
	 * Execute the code of the operations as primary execution
	 */
	public abstract void executeShadow(IDefDatabase iDefDatabase, IPrimaryExec exec);
