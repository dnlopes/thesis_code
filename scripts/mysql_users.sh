...
bin/mysql --defaults-file=my.cnf -u root -p101010 -e "CREATE USER 'sa'@'localhost' IDENTIFIED BY PASSWORD '101010';"
bin/mysql --defaults-file=my.cnf -u root -p101010 -e "CREATE USER 'sa'@'%' IDENTIFIED BY PASSWORD '101010';"
