...
plot data1 every ::1 using 2:3 with linespoints ls 5 title 'TBD 3-replica', data2 every ::1 using 2:3 with linespoints ls 6 title 'TBD 5-replica', data3 every ::1 using 2:3 with linespoints ls 3 title 'Galera Cluster 3-replica', data4 every ::1 using 2:3 with linespoints ls 4 title 'Galera Cluster 5-replica',