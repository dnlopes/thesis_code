...
plot data1 every ::1 using 2:3 with linespoints ls 5 title 'Middleware 3-replica', data2 every ::1 using 2:3 with linespoints ls 6 title 'Middleware 5-replica', data3 every ::1 using 2:3 with linespoints ls 1 title 'Galera Cluster 3-replica', data4 every ::1 using 2:3 with linespoints ls 2 title 'Galera Cluster 5-replica'