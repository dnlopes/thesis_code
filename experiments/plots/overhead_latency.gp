...
plot data1 every 18::4 using 7:xtic(1) lc rgb blue lw 3.5 fs pattern 1 title 'Unique IDs', data2 every 18::4 using 7:xtic(1) lc rgb orange lw 3.5 fs pattern 6 title 'Unique+Seq IDs'
