...
plot data1 every 18::13 using ($3/60):7 with linespoints ls 5 lc rgb green lw 2.0 ps 1.5 title 'WeaQL',\
data2 every 6::1::30 using ($3/60):7 with linespoints ls 7 lc rgb purple lw 2.0 ps 1.6 title 'Galera-Cluster',\
data3 every 6::1::30 using ($3/60):7 with linespoints ls 9 lc rgb orange lw 2.0 ps 1.9 title 'MySQL-Cluster'
