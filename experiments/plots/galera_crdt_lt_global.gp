...
plot data1 every 6 using ($3/60):7 with linespoints ls 5 title 'WeakDB-5R', data2 every 6 using ($3/60):7 with linespoints ls 3 title 'WeakDB-3R', data3 every 6 using ($3/60):7 with linespoints ls 7 title 'WeakDB-5R', data4 every 6 using ($3/60):7 with linespoints ls 9 title 'WeakDB-3R'
