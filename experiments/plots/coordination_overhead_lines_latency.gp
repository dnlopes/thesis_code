...
plot data1 every 6::4 using 1:7 with linespoints ls 5 lc rgb blue lw 2.0 title 'Unique IDs',\
data2 every 6::4 using 1:7 with linespoints ls 3 lc rgb red lw 1.0 title 'Unique+Seq IDs'
